...
fn skip(a: Point3<f64>, b: Point3<f64>) -> bool {
    a.z < 0. && b.z < 0.
}
...
fn main() {
    ...
    'running: loop {
        ...
        for event in event_pump.poll_iter() {
            match event {
                ...
                Event::KeyDown { keycode: Some(Keycode::W), .. } => {
                    ...
                    transform = Matrix4::from_translation(Vector3::new(0., 0., 1.));
                }
                ...
                Event::KeyDown { keycode: Some(Keycode::A), .. } => {
                    ...
                    transform = Matrix4::from_translation(Vector3::new(-1., 0., 0.));
                }
                ...
                Event::KeyDown { keycode: Some(Keycode::Up), .. } => {
                    ...
                    transform = Matrix4::from_translation(Vector3::new(0., 1., 0.));
                }
                ...
                Event::KeyDown { keycode: Some(Keycode::Q), .. } => {
                    ...
                    transform = Matrix4::from_scale(ZOOM_STEP);
                }
                ...
                Event::KeyDown { keycode: Some(Keycode::I), .. } => {
                    ...
                    transform = Matrix4::from_angle_x(cgmath::Deg(ROT_STEP));
                }
                ...
                Event::KeyDown { keycode: Some(Keycode::J), .. } => {
                    ...
                    transform = Matrix4::from_angle_y(cgmath::Deg(ROT_STEP));
                }
                ...
                Event::KeyDown { keycode: Some(Keycode::O), .. } => {
                    ...
                    transform = Matrix4::from_angle_z(cgmath::Deg(ROT_STEP));
                }
        ...
        for obj in &mut objects {
            ...
            obj.cast_2d(FOV, AR, NEAR, FAR);
            obj.screen_coords(VW, VH);
            for line in &obj.edges {
                if skip(obj.vertices[line.0], obj.vertices[line.1]) {
                    continue;
                }

                let a = Point::new(
                    obj.vertices[line.0].x as i32,
                    obj.vertices[line.0].y as i32,
                );
                let b = Point::new(
                    obj.vertices[line.1].x as i32,
                    obj.vertices[line.1].y as i32,
                );
